...
<section class="flat-section pt-0">
    <div class="container2">
        ...
        <div dir="ltr" class="swiper tf-sw-partner" data-preview="6" data-tablet="4" data-mobile-sm="3" data-mobile="2"
                    ...
                    <div class="partner-item">
                        <svg width="160" height="80" viewBox="0 0 160 80" fill="none"
                            ...
                            <path
                                ...
                                fill="#B9B9B9" />
                            <path d="M85.1939 44.2599L106.665 7.0459H103.186L83.4541 41.2471V41.2895L85.1939 44.2599Z"
                                fill="#B9B9B9" />
                ...
                <div class="swiper-slide">
                    <div class="partner-item">
                        <svg width="160" height="80" viewBox="0 0 160 80" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect width="160" height="80" fill="white" />
                            <path d="M37.8612 32.6509L32.1848 38.3062L34.3705 40.4838L40.0795 34.8285L37.8612 32.6509Z"
                                fill="#EBEBEB" />
                            <path d="M26.3781 44.0913L20.7017 49.7466L22.8875 51.9567L28.5639 46.2689L26.3781 44.0913Z"
                                fill="#BBBBBB" />
                            <path d="M30.7828 36.9084L36.4592 31.2206L34.2734 29.043L28.5644 34.6983L30.7828 36.9084Z"
                                fill="#BBBBBB" />
                            <path d="M24.9748 42.6935L22.7564 40.4834L17.08 46.1712L19.2658 48.3488L24.9748 42.6935Z"
                                fill="#EBEBEB" />
                            <path d="M24.9748 38.3062L19.2658 32.6509L17.08 34.8285L22.7564 40.4838L24.9748 38.3062Z"
                                fill="#EBEBEB" />
                            <path d="M26.3781 36.9084L28.5639 34.6983L22.8875 29.043L20.7017 31.2206L26.3781 36.9084Z"
                                fill="#BBBBBB" />
                            <path d="M32.1848 42.6935L37.8612 48.3488L40.0795 46.1712L34.3705 40.4834L32.1848 42.6935Z"
                                fill="#EBEBEB" />
                            <path d="M36.4592 49.7466L30.7828 44.0913L28.5644 46.2689L34.2734 51.9567L36.4592 49.7466Z"
                                fill="#BBBBBB" />
                            <path
                            ...
                            <path
                                ...
                                fill="#BBBBBB" />
                            <path d="M61.9386 49.3008V46.2639H62.9084V45.7808H60.4144V46.2639H61.3843V49.3008H61.9386Z"
                                fill="#BBBBBB" />
                            <path
