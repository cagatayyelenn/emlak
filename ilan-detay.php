...
$gorseller = array_filter($medyalar, function ($m) {
    return $m['medya_tipi'] === 'gorsel'; });
$videolar = array_filter($medyalar, function ($m) {
    return in_array($m['medya_tipi'], ['video', 'video_url']); });
...
<style>
    ...
    .header-property-custom {
        margin-bottom: 30px;
    }

    .header-property-custom .title-area h2 {
        font-size: 32px;
        font-weight: 800;
        color: #1a1a1a;
        margin-bottom: 8px;
    ...
    .header-property-custom .location {
        color: #666;
        font-size: 16px;
        display: flex;
        align-items: center;
    ...
    .header-property-custom .location i {
        color: #4361ee;
    }

    .header-property-custom .location a {
        color: #666;
    ...
    .gallery-grid-v2 .grid-item {
        position: relative;
        overflow: hidden;
        border-radius: 16px;
    }

    .gallery-grid-v2 .grid-item img {
        width: 100%;
        height: 100%;
        object-fit: cover;
    ...
    .gallery-grid-v2 .grid-item:hover img {
        transform: scale(1.05);
    }

    .gallery-grid-v2 .item-main {
        grid-column: 1 / 2;
        grid-row: 1 / 3;
    }
...
<div class="container">
    <div class="property-breadcrumb">
        ...
        <a
            href="ilanlar.php?durum=<?php echo urlencode($ilan['durumu']); ?>"><?php echo htmlspecialchars($ilan['durumu']); ?></a>
        <span>/</span>
        <a
            href="ilanlar.php?tip=<?php echo urlencode($ilan['emlak_tipi']); ?>"><?php echo htmlspecialchars($ilan['emlak_tipi']); ?></a>
        <span>/</span>
            ...
            <div class="col-lg-4">
                <div class="price-area-custom">
                    ...
                    <?php if ($ilan['m2_brut'] > 0): ?>
                        <div class="price-sqft"><?php echo number_format($ilan['fiyat'] / $ilan['m2_brut'], 0, ',', '.'); ?>
                            ₺ / m²</div>
                    <?php endif; ?>
                </div>
            </div>
                            ...
                            <div class="info">
                                ...
                                <ul class="list">
                                    <li class="d-flex align-items-center gap-4 text-variant-1"><i
                                            class="icon icon-phone"></i>1-333-345-6868</li>
                                    <li class="d-flex align-items-center gap-4 text-variant-1"><i
                                            class="icon icon-mail"></i>themesflat@gmail.com</li>
                                </ul>
                            </div>
                        </div>
